        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <a href="{{route('users')}}" class="dropdown-item has-icon"> <i class="far
										fa-user"></i> Users
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="{{Route('projects')}}" class="nav-link"><i data-feather="grid"></i><span>Projects</span></a>
            </li>
            <li class="dropdown">
              <a href="{{Route('create_project_page')}}" class="nav-link"><i data-feather="monitor"></i><span>Create Project</span></a>
            </li>
            <li class="dropdown">
              <a href="{{Route('send_message_page')}}" class="nav-link"><i data-feather="mail"></i><span>Send Message</span></a>
            </li>
            <li class="dropdown">
              <a href="{{Route('users')}}" class="nav-link"><i data-feather="user-check"></i><span>Users</span></a>
            </li>
          </ul>
        </aside>
      </div>
